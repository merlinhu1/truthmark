...
**Το Truthmark διατηρεί τεκμηρίωση που ελέγχεται στο Git.**
...
Αυτό το README είναι εν μέρει μεταφρασμένο. Χρησιμοποίησε την αγγλική έκδοση για το πλήρες κείμενο.
