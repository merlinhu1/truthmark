...
Agent runtime: canonical workflow package .truthmark/agent plus host-native skill packages/adapters and this block; inspect checkout directly. Delegation is host-owned.
### Truth Sync
