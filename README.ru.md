...
- проектные проверочные агенты Codex, Claude Code, GitHub Copilot и OpenCode только для чтения под `.codex/agents/`, `.claude/agents/`, `.github/agents/` и `.opencode/agents/` для аудитов с subagents, которыми владеет рабочий процесс
