...
Verification:
- `npm run release:check` passed: lint, format check, typecheck, 413 tests, build, 4 package-integrity tests, and production audit with 0 vulnerabilities.
- `npm pack --dry-run --json --silent` passed for `truthmark@2.3.0`: 21 files and 1,197,928 unpacked bytes.
