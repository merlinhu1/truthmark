...
describe("renderTruthStructureSkillBody", () => {
  it("renders parseable skill frontmatter", () => {
    const parsed = parseFrontmatter(renderTruthStructureSkillBody());
  ...
  it("renders the agent-native structure workflow contract", () => {
    ...
    expect(skill).toContain(
      "product/capabilities or product/decisions and engineering docs under engineering/<kind>/<surface>.md",
    );
