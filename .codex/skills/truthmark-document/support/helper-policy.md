...
Available helpers:
- validate-document-report: optional truthmark>=1.4.0; manual fallback: manually validate support/report-template.md required sections and structured Evidence checked entries
