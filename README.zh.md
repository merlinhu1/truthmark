...
- `.codex/agents/`、`.claude/agents/`、`.github/agents/` 和 `.opencode/agents/` 下项目级 Codex、Claude Code、GitHub Copilot 与 OpenCode 验证代理，以及带显式写入授权的 `truth-doc-writer` 代理，用于工作流自有的 subagent 审计和父代理授权的文档分片
