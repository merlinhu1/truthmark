...
Inspect repository layout, configured route files when present (${config.docs.routing.rootIndex}; ${config.docs.routing.areaFilesRoot}/), canonical docs, and relevant code directly.
...
May write truth docs and configured truth routing files (${config.docs.routing.rootIndex}; ${config.docs.routing.areaFilesRoot}/) only when present; must not rewrite functional code.
Read configured route files (${config.docs.routing.rootIndex}; ${config.docs.routing.areaFilesRoot}/) only when they exist and routing resolution requires them.
