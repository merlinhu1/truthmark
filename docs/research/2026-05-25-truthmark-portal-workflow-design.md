...
This is a non-canonical design note. It is intentionally kept under `docs/research/` so it does not redefine current Truthmark behavior until a reviewed decision is promoted into canonical docs and implementation.
