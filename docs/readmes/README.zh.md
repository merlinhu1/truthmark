...
默认事实文档模板的依据见 [Template Standards](standards/template-standards.md)。该文档说明这些模板如何对齐 ISO/IEC/IEEE 42010、ISO/IEC/IEEE 29148、ISO/IEC/IEEE 12207、ISO/IEC 25010、C4、arc42、OpenAPI、SemVer、Google SRE 和 Diátaxis 等公认软件工程参考。
...
- [Check 诊断](truthmark/engineering/behaviors/check-diagnostics.md)
- [已安装工作流](truthmark/engineering/workflows/installed-workflow-runtime.md)
