...
**Twoi agenci piszą kod. Truthmark utrzymuje dokumentację przyjazną dla człowieka i możliwą do przeglądu w Git.**
...
<<<<<<<< HEAD:docs/readmes/README.pl.md
