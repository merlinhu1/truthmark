...
**Vos agents écrivent du code. Truthmark maintient une documentation lisible par l'homme et vérifiable dans Git.**
...
<<<<<<<< HEAD:docs/readmes/README.fr.md
