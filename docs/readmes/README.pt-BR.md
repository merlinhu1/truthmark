...
**Seus agentes escrevem código. O Truthmark mantém documentação legível por pessoas e revisável no Git.**
...
<<<<<<<< HEAD:docs/readmes/README.pt-BR.md
...
>>>>>>>> origin/main:docs/README.pt-BR.md
