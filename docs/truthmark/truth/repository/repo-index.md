...
RepoIndex output includes `schemaVersion: repo-index/v0`. RouteMap output includes `schemaVersion: route-map/v0` and is derived from `.truthmark/config.yml`, `docs/truthmark/routes/areas.md`, and `docs/truthmark/routes/areas/**/*.md`.
...
- Decision (2026-05-16): RouteMap v0 is aligned to `docs/truthmark/routes/areas.md` instead of introducing a parallel ownership schema.
